...
Ce projet a été généré avec [Angular CLI](https://github.com/angular/angular-cli) version 21.2.12.
...
Une fois le serveur lancé, taper dans la barre de recherche de votre navigateur : `http://localhost:4200/`. L'application se recharge automatiquement lorsqu'une modification est apportée sur un fichier source du projet.
